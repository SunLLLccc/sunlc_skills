...
| 文档 | 何时读 | 一句话定位 |
|------|--------|-----------|
| [docs/02-{序号}-{功能A}.md](docs/02-{序号}-{功能A}.md) | 当你想 {X} 时先读 | {一句话} |
| [docs/02-{序号}-{功能B}.md](docs/02-{序号}-{功能B}.md) | 当你想 {Y}（依赖 {功能A}）时读 | {一句话} |
| docs/02-{序号}-{功能C}.md — 待生成 | {选了但未生成时的"何时读"} | {待生成} |
...
### 从零到理解主线
1. 先读 [docs/02-{序号}-{功能A}.md](docs/02-{序号}-{功能A}.md) —— {为什么先读它：无依赖、是主线基础}
2. 再读 [docs/02-{序号}-{功能B}.md](docs/02-{序号}-{功能B}.md) —— {为什么接着读：依赖 A 的 X 能力}
