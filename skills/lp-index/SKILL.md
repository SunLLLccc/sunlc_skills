...
- `{PROJECT_ROOT}/docs/learning-docs/features/01-001-功能清单.md`：功能清单（读取每条的名称/核心度/复杂度/依赖/是否选中）
...
按 01-001-功能清单.md 各功能的"依赖"字段构建顺序：
...
1. [ ] 读取 01-001-功能清单.md（必须有），解析每功能的名称/核心度/复杂度/依赖/是否选中（`- [x]`）
